...
<div align="center">
    <img src="image/accumulate.png" alt="image" style="zoom:40%;" />
</div>
...
|                  |                                                           Sample #1                                                            |                                                          Sample #2                                                           |
|:----------------:|:------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------:|
|   Output Image   | <img src="image/stay.png" alt="img" style="zoom:50%;" /> <br> <img src="image/no_departure.png" alt="img" style="zoom:50%;" /> | <img src="image/left.png" alt="img" style="zoom:50%;" />  <br> <img src="image/departure.png" alt="img" style="zoom:50%;" /> |
